...
public class ConfigureSimulationPanel extends JPanel 
	...
	//private JComboBox<MachineUIElement.VmAllocationPolicy> policyComboBox;
	...
	public ConfigureSimulationPanel(Simulation sim, ActionListener screenListener){
		...
		// Initialize the policy dropdown
		//policyComboBox = new JComboBox<>(MachineUIElement.VmAllocationPolicy.values());
	...
	private JPanel createAdvancedTab(){
		...
		cmbLoadBalancingPolicy = new JComboBox(new String[]{
				...
				Constants.LOAD_BALANCE_INTRA,
				//Constants.LOAD_BALANCE_INTRA_RL
		});
