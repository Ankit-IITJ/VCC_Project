...
public interface Constants {
	...
	final String DEFAULT_OS = "Ubuntu";
	...
	final int DEFAULT_MC_MEMORY = 8000;
	final long DEFAULT_MC_STORAGE = 1000000;
	final int DEFAULT_MC_BW = 1000;
	final int DEFAULT_MC_PROCESSORS =  4;
	final int DEFAULT_MC_SPEED = 2000;

	final long DEFAULT_VM_IMAGE_SIZE = 1000;//MB
	final int DEFAULT_VM_MEMORY = 512;//MB
	final long DEFAULT_VM_BW = 1000;
	//final int DEFAULT_VM_MIPS=2000;//mips

	//Default User base characteristics
	final String DEFAULT_USER_BASE_NAME = "UB1";
	final int DEFAULT_UB_REGION = 0;
	...
	final String LOAD_BALANCE_INTRA = "Intra Balancer";
	final String LOAD_BALANCE_INTRA_RL = "Intra Balancer RL";
}
